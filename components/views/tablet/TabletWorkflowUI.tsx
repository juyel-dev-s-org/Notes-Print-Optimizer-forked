...
export const TabletWorkflowUI: React.FC<WorkflowUIProps> = ({ state, actions, handlers, toolMode, onToolModeChange }) => {
  if (toolMode === 'enhance') {
    return (
      <div className="flex flex-col gap-5 pb-12 w-full max-w-full overflow-hidden">
