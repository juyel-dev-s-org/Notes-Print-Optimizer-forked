...
export const TabletWorkflowUI: React.FC<WorkflowUIProps> = ({ state, actions, handlers }) => {
  const {
    currentPhase,
    isProcessing,
    uploadedItems,
  ...
  return (
    <div className="flex flex-col gap-5 pb-12 w-full max-w-full">
      ...
      <div className="flex items-center justify-between px-1 text-[10px] text-ink-muted font-mono">
        <span className="flex items-center gap-1.5 bg-surface/80 border border-surface-2 px-2.5 py-0.5 rounded-full">
          <Tablet className="h-3.5 w-3.5 text-primary-soft" />
          Tablet UI Viewport
        </span>
        ...
        <div className="flex flex-col gap-4 animate-in fade-in duration-200">
          ...
          {uploadedItems.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              ...
              <div className="md:col-span-5 flex flex-col gap-3 rounded-2xl border border-surface-2 bg-surface/90 p-4 shadow-xl">
                <div className="flex items-center justify-between border-b border-surface-2 pb-2">
                  ...
                  <span className="rounded-full bg-primary/20 px-2 py-0.5 text-[10px] font-bold text-primary-soft">
                    Step 1 of 4
                  </span>
                </div>
              ...
              <div className="md:col-span-7 flex flex-col gap-3 rounded-2xl border border-surface-2 bg-surface/90 p-4 shadow-xl">
                ...
                <div className="flex items-center justify-between gap-2 pt-3 border-t border-surface-2 mt-auto">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-xl border border-elevated bg-surface-2 px-3.5 py-2 text-xs font-bold text-ink hover:bg-elevated disabled:opacity-40"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex h-11 items-center gap-2 rounded-xl bg-primary-strong px-5 text-xs font-bold text-white shadow-lg hover:bg-primary disabled:opacity-50"
                  >
      ...
      {currentPhase === 2 &&
        ...
        <div className="flex flex-col gap-4 animate-in fade-in duration-200">
          <div className="flex items-center justify-between gap-3 rounded-2xl border border-success-strong/30 bg-success-faint/40 p-4 shadow-lg">
            <div className="flex items-center gap-3 min-w-0">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-success-deep text-bg font-bold shadow-md">
            ...
            <span className="rounded-lg bg-success-strong/20 px-3 py-1 text-xs font-bold text-success-soft border border-success-strong/30 shrink-0">
              ~82% Ink Saved
            </span>
          </div>
          ...
          <div className="flex items-center justify-between rounded-2xl border border-surface-2 bg-surface/90 p-4 shadow-xl">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-xl border border-elevated bg-surface-2 px-4 py-2.5 text-xs font-bold text-ink-muted hover:bg-elevated"
            >
            ...
            <button
              ...
              disabled={isProcessing}
              className="inline-flex h-11 items-center gap-2 rounded-xl bg-primary-strong px-5 text-xs font-bold text-white shadow-lg hover:bg-primary"
            >
      ...
      {currentPhase === 3 &&
        ...
        <div className="flex flex-col gap-4 animate-in fade-in duration-200">
          <div className="flex flex-col gap-4 rounded-2xl border border-surface-2 bg-surface/90 p-4 shadow-xl">
            <div className="flex items-center justify-between border-b border-surface-2 pb-2">
              <div>
                <h3 className="text-xs font-bold text-white">N-Up Grid Layout & Paper Format</h3>
                <p className="text-[11px] text-ink-muted">Select slide density per printed sheet.</p>
              </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-surface-2 text-xs">
              <button
                ...
                className="flex h-10 items-center gap-1.5 rounded-xl border border-elevated bg-surface-2 px-3 font-semibold text-ink"
              >
        ...
        {finalSheetPreviews.length > 0 && (
          ...
          <div className="flex items-center justify-between rounded-2xl border border-surface-2 bg-surface/90 p-4 shadow-xl">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-xl border border-elevated bg-surface-2 px-4 py-2 text-xs font-bold text-ink-muted hover:bg-elevated"
            >
              <ArrowLeft className="h-4 w-4" />
              <span>Back</span>
            </button>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex h-11 items-center gap-1 rounded-xl bg-surface-2 px-3.5 text-xs font-bold text-ink hover:bg-elevated"
              >
                <span>Finish</span>
                <ArrowRight className="h-4 w-4" aria-hidden="true" />
              </button>
      ...
      {currentPhase === 4 &&
        ...
        <div className="flex flex-col items-center gap-5 text-center animate-in fade-in duration-200 max-w-lg mx-auto">
          <div className="flex flex-col items-center gap-3 rounded-2xl border border-success-strong/30 bg-surface/90 p-6 shadow-xl w-full">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-success-strong/20 text-success border border-success-strong/30">
            ...
            {finalPrintPdfBlob && (
              <button
                type="button"
                onClick={onDownloadFinalPrintPdf}
                className="mt-3 flex h-11 w-full max-w-xs items-center justify-center gap-2 rounded-xl bg-primary-strong text-xs font-bold text-white shadow-lg hover:bg-primary"
              >
                <Download className="h-4 w-4" />
          ...
          <button
            ...
            className="flex h-11 items-center gap-2 rounded-xl border border-elevated bg-surface-2/80 px-6 text-xs font-bold text-ink hover:bg-elevated"
          >
