      ...
      {currentPhase === 4 && (
        <div className="flex flex-col items-center gap-4 text-center animate-in fade-in duration-200">
          ...
          <div className="flex flex-col gap-3 rounded-2xl border border-slate-800 bg-slate-900/90 p-4 shadow-xl w-full text-left">
            <h3 className="text-xs font-bold text-white border-b border-slate-800 pb-1">Rate Experience</h3>
            {!feedbackSubmitted ? (
              <div className="flex flex-col gap-2.5">
                ...
                <button
                  ...
                  className="flex h-10 items-center justify-center rounded-xl bg-slate-800 text-xs font-bold text-white"
                >
                  Send Feedback
                </button>
              </div>
