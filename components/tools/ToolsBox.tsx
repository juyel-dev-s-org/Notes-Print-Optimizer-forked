  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-1">
        ...
        <span className="inline-flex items-center gap-1 rounded-full border border-highlight/25 bg-highlight-faint px-2.5 py-1 text-[11px] font-bold text-highlight shadow-sm">12 Free • No sign-up</span>
      </div>
