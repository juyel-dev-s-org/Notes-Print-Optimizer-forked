...
export const PhaseSkeleton: React.FC<{ phaseName: string }> = ({ phaseName }) => (
  <div className="flex flex-col gap-4 animate-pulse">
    ...
    <div className="h-32 rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
...
export const CardSkeleton: React.FC = () => (
  <div className="flex flex-col gap-3 rounded-2xl border border-slate-800 bg-slate-900/60 p-4 animate-pulse">
