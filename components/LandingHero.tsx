...
export const LandingHero: React.FC = () => (
  <section
    ...
    className="relative overflow-hidden rounded-2xl border border-slate-800/70 bg-gradient-to-b from-[#0b1230]/50 via-slate-900/60 to-slate-900/40 px-5 py-7 sm:py-9 text-center animate-slide-up"
  >
    ...
    <div className="relative flex flex-col items-center gap-3.5">
      ...
      <h1 className="max-w-3xl text-balance text-[26px] font-extrabold leading-tight tracking-tight text-white sm:text-4xl">
        Every PDF,{' '}
      ...
      <p className="max-w-xl text-pretty text-xs leading-relaxed text-slate-400 sm:text-sm">
        ...
        <span className="font-semibold text-slate-300"> on your device</span>. Instant, private, no uploads.
      </p>
      ...
      <div className="hidden w-full max-w-2xl grid-cols-4 gap-2 sm:grid">
        {heroStats.map((stat) => (
          <div key={stat.label} className="flex flex-col items-center gap-1 rounded-xl border border-slate-800/50 bg-slate-900/30 px-2 py-2.5 backdrop-blur-sm">
