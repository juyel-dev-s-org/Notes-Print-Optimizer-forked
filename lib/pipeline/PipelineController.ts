...
export class PipelineController {
  ...
  async runDocument(pdfBuffer: ArrayBuffer, options: PipelineRunOptions): Promise<{ pages: PagePipelineResult[]; totalMetrics: { durationMs: number; pagesPerSecond: number } }> {
    ...
    const device: DeviceProfile = deviceProfile ?? { cores: typeof navigator !== 'undefined' ? navigator.hardwareConcurrency || 4 : 4, memoryGB: typeof navigator !== 'undefined' ? (navigator as any).deviceMemory || 4 : 4, isMobile: false, isTablet: false, supportsWASM: typeof WebAssembly !== 'undefined', supportsOffscreenCanvas: typeof OffscreenCanvas !== 'undefined', maxRenderDim: 2400 };
